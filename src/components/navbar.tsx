...
export default function Navbar() {
  ...
  return (
    <nav className="fixed font-heading top-0 left-0 w-full z-50 flex justify-between items-center text-xl font-semibold p-5 bg-primary text-primary-foreground">
      <div>
        <h1 className="text-2xl font-bold font-heading"><Link href='/'>VYV</Link></h1>
      </div>
      ...
      <div className="hidden md:flex items-center gap-3">
        ...
        <div><Link href='/account'><User className="h-6 w-6" /></Link></div>
        <div className="relative">
          <Link href='/cart'>
        ...
        <Sheet>
          ...
          <SheetContent side="right">
            ...
            <div className="flex pt-2 p-4 flex-col gap-4">
              ...
              <div><Link href='/account'><User className="h-5 w-5 inline mr-2" />Account</Link></div>
              <div className="relative">
                <Link href='/cart'>
