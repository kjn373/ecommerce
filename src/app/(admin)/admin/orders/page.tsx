        ...
        <Popover>
          ...
          <PopoverContent className="w-80">
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                <div>
                  <Label className='mb-1' htmlFor="status-filter">Status</Label>
                  <Select
                    value={statusFilter}
                    onValueChange={(value: Order['status'] | 'all') => setStatusFilter(value)}
                  >
                ...
                <div>
                  <Label className='mb-1' htmlFor="start-date">Start Date</Label>
                  <Input
                    id="start-date"
                    type="date"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="space-y-1 text-sm">
                    ...
                    <p><span className="font-medium">Postal Code:</span> {selectedOrder.postalCode}</p>
                  </div>
                </div>
                <div>
                  <h3 className="font-medium mb-2">Order Information</h3>
                  <div className="space-y-1 text-sm">
                    <p><span className="font-medium">Date:</span> {format(new Date(selectedOrder.createdAt), 'PPpp')}</p>
                    <div><span className="font-medium">Status:</span> 
                      <Badge className={`ml-2 ${getStatusColor(selectedOrder.status)}`}>
                        {selectedOrder.status.charAt(0).toUpperCase() + selectedOrder.status.slice(1)}
                      </Badge>
                    </div>
                    <p><span className="font-medium">Shipping Cost:</span> ${selectedOrder.shippingCost.toFixed(2)}</p>
                  ...
                  <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="divide-y divide-gray-200">
                      {selectedOrder.products.map((product, index) => (
                        <tr key={index}>
                          <td className="px-4 py-2 text-sm">{product.productId.name}</td>
                          ...
                          <td className="px-4 py-2 text-sm text-right">${(product.quantity * product.price).toFixed(2)}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
