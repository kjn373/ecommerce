...
const subheadingStyle: string =
  "text-base md:text-lg font-heading font-semibold";
    ...
    <>
        ...
        <div className="max-w-xl mx-auto text-center">
          ...
          <form className="flex flex-col sm:flex-row gap-4 justify-center max-w-xs sm:max-w-md mx-auto">
            <input
              ...
              className="px-4 py-2 rounded border border-gray-300 focus:outline-none focus:ring-2 flex-1 w-full"
            />
            <Button
              type="submit"
              className="px-6 font-body py-2"
              variant="default"
            >
              Subscribe
            </Button>
      ...
      <footer className="bt-1 grid grid-cols-1 sm:grid-cols-2 lg:md:grid-cols-4 mx-10 sm:mx-44 my-10">
        <div className={divStyle}>
          ...
          <p className={subLinkStyle}>
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dolore
            numquam modi accusantium. Modi quibusdam quas suscipit quis
            repudiandae.
          </p>
        </div>
        <div className={divStyle}>
          ...
          <ul className="space-y-1 md:space-y-2 text-xs md:text-sm">
            <li>
              <Link href="/about" className={subLinkStyle}>
                About
              </Link>
            </li>
            <li>
              <Link href="#" className={subLinkStyle}>
            ...
            <li>
              <Link href="/contact" className={subLinkStyle}>
                Contact Us
              </Link>
            </li>
          </ul>
